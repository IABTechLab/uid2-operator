FROM eclipse-temurin@sha256:124d6d14a08ad71b0c10b107f663de7b42787fb48cda8a82e5b1ca881772a832
...
CMD java \
    -XX:MaxRAMPercentage=95.0 -XX:-UseCompressedOops -XX:+PrintFlagsFinal -XX:-OmitStackTraceInFastThrow \
