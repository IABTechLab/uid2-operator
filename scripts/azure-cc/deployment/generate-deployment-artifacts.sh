...
# Inject a base64 encoded Confidential Container Security Policy into the ARM Template
az confcom acipolicygen --approve-wildcards --template-file ${OUTPUT_DIR}/operator.json
