...
public class UIDOperatorVerticleTest {
    ...
    private void send(String apiVersion, Vertx vertx, String endpoint, JsonObject postPayload, int expectedHttpCode, Handler<JsonObject> handler) {
        send(apiVersion, vertx, endpoint, postPayload, expectedHttpCode, handler, Collections.emptyMap());
    }
    ...
    void keyLatestNoAcl(String apiVersion, String contentType, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/key/latest", null, 200, respJson -> {
    ...
    void keyLatestClientBelongsToReservedSiteId(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/key/latest", null, 401, respJson -> testContext.completeNow());
    }
    ...
    @CsvSource({"v2, text/plain",
                "v2, application/octet-stream"})
    void identityMapNewClientNoPolicySpecified(String apiVersion, String contentType, Vertx vertx, VertxTestContext testContext) {
        final int clientSiteId = 201;
        ...
        send(apiVersion, vertx, apiVersion + "/identity/map", req, 200, respJson -> {
    ...
    void identityMapNewClientNoPolicySpecifiedOlderKeySuccessful(Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2/identity/map", req, 200, respJson -> {
            assertTrue(respJson.containsKey("body"));
            assertEquals("success", respJson.getString("status"));
            testContext.completeNow();
        });
    ...
    void v3IdentityMapMixedInputSuccess(String contentType, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v3/identity/map", request, 200, respJson -> {
    ...
    void v3IdentityMapMissingValidInputKeys(String inputPayload, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v3/identity/map", request, 400, respJson -> {
    ...
    @CsvSource({"v2, text/plain",
                "v2, application/octet-stream"})
    void tokenGenerateForEmail(String apiVersion, String contentType, Vertx vertx, VertxTestContext testContext) {
        final int clientSiteId = 201;
        final String emailAddress = "test@uid2.com";
        fakeAuth(clientSiteId, Role.GENERATOR);
        setupSalts();
    ...
    void tokenGenerateThenValidateWithEmail_Match(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        generateTokens(apiVersion, vertx, "email", emailAddress, genRespJson -> {
            ...
            send(apiVersion, vertx, apiVersion + "/token/validate", v2Payload, 200, json -> {
    ...
    void tokenGenerateThenValidateWithBothEmailAndEmailHash(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        generateTokens(apiVersion, vertx, "email", emailAddress, genRespJson -> {
            ...
            send(apiVersion, vertx, apiVersion + "/token/validate", v2Payload, 400, json -> {
                assertFalse(json.containsKey("body"));
                assertEquals("client_error", json.getString("status"));
    ...
    @ParameterizedTest
    @CsvSource({"v2,asdf", "v2,invalidBase64%%%%"})
    ...
    void tokenValidateWithEmail_Mismatch(String apiVersion, String contentType, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/token/validate", new JsonObject().put("token", "abcdef").put("email", emailAddress),
                200,
                respJson -> {
    ...
    void tokenValidateWithEmailHash_Mismatch(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/token/validate",
    ...
    void identityMapBatchBothEmailAndHashSpecified(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/identity/map", req, 400, respJson -> {
    ...
    void identityMapBatchNoEmailOrHashSpecified(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/identity/map", req, 400, json -> {
            assertFalse(json.containsKey("body"));
            assertEquals("client_error", json.getString("status"));
    ...
    void identityMapBatchEmails(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/identity/map", req, 200, json -> {
    ...
    void identityMapBatchRequestTooLarge(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/identity/map", req, 413, json -> testContext.completeNow());
    }
    ...
    void optOutStatusRequest(Map<String, Long> optedOutIds, int optedOutCount, Role role, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2/optout/status", requestJson, 200, respJson -> {
            assertEquals("success", respJson.getString("status"));
    ...
    void optOutStatusValidationError(JsonObject requestJson, String errorMsg, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2/optout/status", requestJson, 400, respJson -> {
    ...
    void optOutStatusUnauthorized(String contentType, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2/optout/status", new JsonObject(), 401, respJson -> {
    ...
    void LogoutV2(String contentType, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2/token/logout", req, 200, respJson -> {
            assertEquals("success", respJson.getString("status"));
    ...
    void tokenGenerateBothPhoneAndHashSpecified(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/token/generate", v2Payload, 400, json -> {
            assertFalse(json.containsKey("body"));
            assertEquals("client_error", json.getString("status"));
    ...
    void tokenGenerateRespectOptOutOption(String policyParameterKey, Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2/token/generate", req, 200, json -> {
            try {
    ...
    void keySharingKeysets_CorrectFiltering(String contentType, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/key/sharing",  null, 200, respJson -> {
            System.out.println(respJson);
    ...
    public class keyBidstreamCustomMaxBidstreamLifetime {
        ...
        public void keyBidstreamReturnsCustomMaxBidstreamLifetimeHeader(Vertx vertx, VertxTestContext testContext) {
            ...
            send(apiVersion, vertx, apiVersion + endpoint.getPath(),  null, 200, respJson -> {
                assertEquals("success", respJson.getString("status"));
    ...
    void secureLinkValidationPassesReturnsIdentity(Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2" + "/identity/map", req, 200, json -> {
            checkIdentityMapResponse(json, "test1@uid2.com", "test2@uid2.com");
            testContext.completeNow();
        });
    }
    ...
    void secureLinkValidationFailsReturnsIdentityError(Vertx vertx, VertxTestContext testContext) {
        ...
        send("v2", vertx, "v2" + "/identity/map", req, 401, json -> {
            assertEquals("unauthorized", json.getString("status"));
    ...
    void identityBucketsAlwaysReturnMilliseconds(String apiVersion, Vertx vertx, VertxTestContext testContext) {
        ...
        send(apiVersion, vertx, apiVersion + "/identity/buckets", req, 200, respJson -> {
